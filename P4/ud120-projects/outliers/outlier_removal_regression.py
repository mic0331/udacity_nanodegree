...
print 'before cleaning, slope is ', reg.coef_[0][0]
print 'before cleaning, score is ', reg.score(ages_test,net_worths_test)
...
print 'after cleaning, slope is ', clf_after_cleaned.coef_[0][0]
print 'after cleaning, score is ', clf_after_cleaned.score(ages_test,net_worths_test)
