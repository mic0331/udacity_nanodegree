...
print "regression bonus against salary "
...
print 'score training data ', clf.score(feature_train,target_train)
print 'score testing data ', clf.score(feature_test,target_test)

# --------
#print "regression bonus against long term incentive "
